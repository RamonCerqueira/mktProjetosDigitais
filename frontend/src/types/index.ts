...
export interface Offer { id: number; projectId: number; amount: number; status: string; buyerId: number; sellerId: number; proposerId: number; parentOfferId?: number | null; negotiationKey: string; }
