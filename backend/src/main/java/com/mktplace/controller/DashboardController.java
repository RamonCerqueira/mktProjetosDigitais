...
public class DashboardController {
    ...
    public DashboardResponse getDashboard() {
        ...
        return new DashboardResponse(new UserResponse(user.getId(), user.getName(), user.getEmail(), user.getRole()), subscriptionService.getStatus(user), projectService.myProjects(user), offerService.myOffers(user));
    }
}
